...
class RectangleWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self.hover_blue or self.hover_green or self.hover_grey:
            ...
            rewind_path.lineTo(self.rewind_rect.x() + self.rewind_rect.width() * 0.7, self.rewind_rect.top() + self.rewind_rect.height() * 0.2)
            rewind_path.lineTo(self.rewind_rect.x() + self.rewind_rect.width() * 0.7, self.rewind_rect.bottom() - self.rewind_rect.height() * 0.2)
            ...
            rewind_path.lineTo(self.rewind_rect.x() + self.rewind_rect.width() * 0.9, self.rewind_rect.top() + self.rewind_rect.height() * 0.2)
            rewind_path.lineTo(self.rewind_rect.x() + self.rewind_rect.width() * 0.9, self.rewind_rect.bottom() - self.rewind_rect.height() * 0.2)
            ...
            fast_forward_path.lineTo(self.fast_forward_rect.x() + self.fast_forward_rect.width() * 0.3, self.fast_forward_rect.top() + self.fast_forward_rect.height() * 0.2)
            fast_forward_path.lineTo(self.fast_forward_rect.x() + self.fast_forward_rect.width() * 0.3, self.fast_forward_rect.bottom() - self.fast_forward_rect.height() * 0.2)
            ...
            fast_forward_path.lineTo(self.fast_forward_rect.x() + self.fast_forward_rect.width() * 0.1, self.fast_forward_rect.top() + self.fast_forward_rect.height() * 0.2)
            fast_forward_path.lineTo(self.fast_forward_rect.x() + self.fast_forward_rect.width() * 0.1, self.fast_forward_rect.bottom() - self.fast_forward_rect.height() * 0.2)
